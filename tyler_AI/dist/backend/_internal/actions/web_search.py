...
class WebSearch:
    def __init__(self):
        self.cache = {}
        self.api_key = "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"
    ...
    def search_video(self, query, platform="youtube"):
        ...
        return [{
            "title": query,
            "link": f"https://yandex.ru/video/search?text={query}"
        }]

    def generate_url(self, query: str, platform: str, type_: str):
        return [{
            "title": query,
            "link": f"https://yandex.ru/search/?text={query}"
        }]
