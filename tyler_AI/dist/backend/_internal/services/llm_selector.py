...
import actions.action_brain as action_brain
import memory.shortMemory as shortMemory
import memory.action_memory as action_memory
...
async def ask_llm(messages: list, model: str, chat_id: str):    
    ...
    async with httpx.AsyncClient(timeout=configs.TIMEOUT) as client:
        ...
        elif model == "nvidia/nemotron-3-super-120b-a12b:free":
...
9) file_manager
Описание: создаёт или открывает txt/pdf/docx файлы.
