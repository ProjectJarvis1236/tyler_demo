...
voice = "ru-RU-DmitryNeural" # в гитхабе есть проект,который распознают слова на разных языках и выводит текстом, может как-то прикрутить к нашему проекту можно
